"""
Django settings for LalSobujBank project.
...
# SECRET_KEY = 'django-insecure-_c9wbdy38!ak*47y)*ocxpr&ww_wv4cx4^&t8-_w@88g18#%px'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ['https://lalsobujbank.onrender.com']
...
ROOT_URLCONF = 'LalSobujBank.urls'
...
WSGI_APPLICATION = 'LalSobujBank.wsgi.application'
